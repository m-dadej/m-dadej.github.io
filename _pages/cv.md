...
layout: archive
title: "CV"
description: "Curriculum vitae — education, research, publications and professional experience."
permalink: /cv/
author_profile: true
redirect_from:
  - /resume
...
## Education
* PhD, Analytics in Economics, University of Brescia, 2021 - 2025
...
* Data analysis:
  ...
  - General proficiency in data analysis
* Programming:
  - Advanced knowledge of R programming language (tidyverse, ggplot2, keras, Rmarkdown)
  - Advanced in Julia programming language (I developed [MarSwitching.jl](/code/), a package for Markov switching models)
  - Good knowledge of Python (pandas, numpy, matplotlib)

## Publications
  <div>{% for post in site.publications %}
    {% include archive-single-cv.html %}
  {% endfor %}</div>
  
## Achievements

* III place in "Young Economist" competition 
  - For an essay "Global economy after COVID-19 epidemic". Organised by Polish Association of Economists
* Best economic paper on VI Interdisciplinary Student's Conference in Szczecin, 2020
III and I place in "Great Finance Challenge" 
...
* Business Academy by Deloitte, Mergers and Acquisitions, 2018
